    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.sessionManagement()
             ...
             .and().authorizeRequests()
                .antMatchers(HttpMethod.GET, "/nfts/favorites", "/users/current", "/users/*/buyorders", "/purchases", "/purchases/*").hasAnyRole("USER","ADMIN")
                .antMatchers(HttpMethod.GET, "/nfts", "/nfts/*", "/users/*", "/users/*/inventory", "/users/*/reviews", "/reviews/*", "/sellorders", "/sellorders/*", "/sellorders/*/buyorders").permitAll()
                .antMatchers(HttpMethod.PUT, "/nfts/*/favorite", "/sellorders/*", "/sellorders/*/buyorders/*").hasAnyRole("USER","ADMIN")
                .antMatchers(HttpMethod.POST, "/nfts", "/users", "/reviews", "/reviews", "/sellorders", "/sellorders/*/buyorders", "/sellorders/*/buyorders/*").hasAnyRole("USER","ADMIN")
