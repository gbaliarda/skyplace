...
const FilterSideBar = ({
  ...
  const changeValueFilters = (
    ...
    if (toAdd)
      addQueryParam(filterType.toLowerCase(), newValue)
    else
      removeQueryParam(filterType.toLowerCase(), newValue)
  }
        ...
        <div className="flex flex-col w-72 min-w-[250px] items-center">
          ...
          <div className="grow w-full overflow-y-scroll mt-2">
            <div className="py-4 flex flex-col w-full">
              ...
              <CategoryFilter changeValueFilters={changeValueFilters} categories={filters.category} />

              <ChainFilter changeValueFilters={changeValueFilters} chains={filters.chain} />

              <PriceFilter applyPriceFilter={applyPriceFilter} minPrice={filters.minPrice} maxPrice={filters.maxPrice} />
            </div>
          </div>
        </div>
      ) : (
